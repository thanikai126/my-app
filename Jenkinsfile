node{
   ...
   sh "docker login -u admin -p admin123 3.111.29.24:8083"
   sh "docker tag thanikaidoc/myweb:0.0.2 3.111.29.24:8083/damo:1.0.0"
   sh 'docker push 3.111.29.24:8083/damo:1.0.0'
   }
